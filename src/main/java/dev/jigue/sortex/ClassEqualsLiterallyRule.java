...
final class ClassEqualsLiterallyRule extends ClassRule {
    private ClassEqualsLiterallyRule(final String className) {
        this.className = className;
    }

    static ClassEqualsLiterallyRule of(final String className) {
        return new ClassEqualsLiterallyRule(className);
    }

    static ClassEqualsLiterallyRule from(final Object classNameObject) {
    ...
    static final String KEY = "class_equals_literally";
