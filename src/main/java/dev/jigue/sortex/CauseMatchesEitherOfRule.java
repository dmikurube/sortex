...
public final class CauseMatchesEitherOfRule extends CauseRule {
    ...
    public static CauseMatchesEitherOfRule of(final List<CauseExceptionRule> causeRules) {
        return new CauseMatchesEitherOfRule(causeRules);
    }

    public static CauseMatchesEitherOfRule of(final CauseExceptionRule... causeRules) {
        return CauseMatchesEitherOfRule.of(Arrays.asList(causeRules));
    }

    public static CauseMatchesEitherOfRule from(final Object causeRulesObject)
    ...
    public static final String KEY = "cause_matches_either_of";
